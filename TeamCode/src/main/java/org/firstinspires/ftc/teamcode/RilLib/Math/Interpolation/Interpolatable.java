...
/**
 * An object should extend interpolatable if you wish to interpolate between a
 * lower and upper
 * bound, such as a robot position on the field between timesteps. This behavior
 * can be linear or
 * nonlinear.
 *
